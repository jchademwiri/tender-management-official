...
CREATE TABLE `Tender` (
    ...
    `closingDate` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `closingTime` VARCHAR(191) NOT NULL DEFAULT '10:00',
    `Status` ENUM('OPEN', 'IN_PROGRESS', 'SUBMITTED', 'APPOINTED') NOT NULL DEFAULT 'OPEN',
    ...
    UNIQUE INDEX `Tender_number_key`(`number`),
    PRIMARY KEY (`id`)
