...
-- AddForeignKey
ALTER TABLE `TenderToCompany` ADD CONSTRAINT `TenderToCompany_tenderId_fkey` FOREIGN KEY (`tenderId`) REFERENCES `Tender`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `TenderToCompany` ADD CONSTRAINT `TenderToCompany_companyId_fkey` FOREIGN KEY (`companyId`) REFERENCES `Company`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
